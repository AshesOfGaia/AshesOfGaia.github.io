...
All weapons come with three built-in attachment points that do not count toward a weapon’s attachment limit. These built-in points are fixed to: Sight, Grip, and Magazine only — they cannot be used for other attachment types.

In addition, each weapon class grants extra, freely-spendable attachment points that can be used for any attachment type (sights, grips, magazines, barrels, rails, mods, etc.):

- Handgun: +1 extra attachment point

- Submachine gun / Shotgun / Rifle: +3 extra attachment points

- Heavy weapon / Machine gun: +2 extra attachment points

Example: a rifle automatically has Sight, Grip and Magazine slots (these don’t count toward the limit) plus three extra attachment points that you may use for any additional attachments.

|       Weapon attchment          |                    Compatible Type                     |                    Compatible Subtype                     | Desciption | Game Mechanics | Weight | Price | Slots Taken|
| :-----------------------------: | :----------------------------------------------------: | :-------------------------------------------------------: | :--------: | :------------: | :----: | :---: | :--------: |
|         SCOPE 5–20X             | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | SHORT ARMS, LONG ARMS                                     | A variable-power scope providing 5×–20× magnification, allowing the shooter to precisely adjust magnification before firing. | Raises the weapon effective range up to two times the base range. The –30 penalty for shooting beyond the weapon’s base range remains. The new (extended) range may be used only when taking a single-shot action. |  2  |        200cr         |       1         |
|   INFRARED NIGHT VISION SCOPE   | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | SHORT ARMS, LONG ARMS, HEAVY ARMS                         | Enables viewing of the environment in the infrared band; objects are visible based on emitted heat. | You do not suffer penalties imposed by darkness, smoke, fog, etc. |  3  |        150cr         |       2         |
|         DRUM MAGAZINE           | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL           | A high-capacity magazine that greatly increases the weapon’s ammunition capacity, improving sustained fire capability. | Doubles the weapon’s magazine size. |  5  |        20cr          |       1         |
|       EXTENDED MAGAZINE         | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | ANY                                                       | Increased-capacity magazine that allows more rounds before reloading. | Weapon magazine capacity is 50% higher than standard. |  2  |        10cr          |       0         |
...
|        EXTENDED STOCK           | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | ANY                                                       | Stock modified to accept additional attachments; less ergonomic but increases attachment capacity. Cannot be installed together with Personalized Stock. | Grants 1 additional attachment slot to the weapon. |  1  |        20cr          |       0         |
...
|  UNDERBARREL GRENADE LAUNCHER   | CONVENTIONAL, ENERGY, ELECTROMAGNETICS, THERMAL        | LONG ARMS                                                 | Underbarrel-mounted grenade launcher with an integrated trigger for convenient use in combat. | The weapon can be used as a grenade launcher with one shot in its magazine. |  4  |        150cr         |       2         |
